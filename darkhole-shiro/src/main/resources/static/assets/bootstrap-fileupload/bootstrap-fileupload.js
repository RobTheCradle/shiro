...
this.$remove=this.$element.find('[asideNav-dismiss="fileupload"]')
this.$element.find('[asideNav-trigger="fileupload"]').on('click.fileupload',$.proxy(this.trigger,this))
this.listen()}
...
$(function(){$('body').on('click.fileupload.asideNav-api','[asideNav-provides="fileupload"]',function(e){var $this=$(this)
if($this.data('fileupload'))return
$this.fileupload($this.data())
var $target=$(e.target).is('[asideNav-dismiss=fileupload],[asideNav-trigger=fileupload]')?$(e.target):$(e.target).parents('[asideNav-dismiss=fileupload],[asideNav-trigger=fileupload]').first()
